...
class DiaristaForm(forms.ModelForm):
    ...
    logradouro = forms.CharField(widget=forms.TextInput(attrs={'name': "rua", 'id':'rua'}))
    bairro = forms.CharField(widget=forms.TextInput(attrs={'name': "bairro", 'id': 'bairro'}))
    estado = forms.CharField(widget=forms.TextInput(attrs={'name': "uf", 'id': 'uf'}))
    cidade = forms.CharField(widget=forms.TextInput(attrs={'name': "cidade", 'id': 'cidade'}))
